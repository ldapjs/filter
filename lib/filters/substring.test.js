...
tap.test('Emits warnings about sub prefix deprecation', t => {
  ...
  t.teardown(async () => {
    ...
    warning.emitted.set('LDAP_SUBSTRING_FILTER_DEP_001', false)
    warning.emitted.set('LDAP_SUBSTRING_FILTER_DEP_002', false)
    warning.emitted.set('LDAP_SUBSTRING_FILTER_DEP_003', false)
  })
